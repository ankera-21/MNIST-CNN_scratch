...
if __name__ == "__main__":
    ...
    traindataset = datasets.MNIST('./data', train=True, download=True, transform=train_transforms)
    testdataset = datasets.MNIST('./data', train=False, download=True, transform=test_transforms)
